...
import { AstTreeUtils } from '../../src/utils/AstTreeUtils';
import { ts } from '../../src';

describe('AstTreeUtils Test', () => {
    it('test getAstNode', async () => {
        let code = 'async function AwaitThenable() { await \'value\'; let creataValue = ()=> \'value1\'; await creataValue;}';
        let sourceFile = AstTreeUtils.getASTNode('testFileName', code);
